...
___
 <a name="1"></a> 
### 1. **Перечень автоматизируемых сценариев тестирования взаимодействия веб-сервиса с API [тесты №№ 01 - 04]**       
...
---    
 <a name="2"></a> 
### 2. **Перечень автоматизируемых сценариев тестирования веб-формы при покупке тура картой [тесты №№ 05 - 18]**       
[вернуться к содержанию](#0) 
___    
...
***
 <a name="3"></a>
### 3. **Перечень автоматизируемых сценариев тестирования веб-формы при покупке тура кредитом по данным карты [тесты №№ 19 - 32]**      
[вернуться к содержанию](#0)      
___   
